...
import { getLeaveIndividual } from '../../Apiservice/apiservice';
    ...
    },
    {
      ...
      renderCell: (params) => {
        if (params.row.status == "pending") {
          return <div style={{ color: 'red' }} className='text-center p-2'>
            {params.row.status}
          </div>
        } else if (params.row.status == "approved") {
          return <div style={{ color: 'green' }} className='text-center p-2'>
            {params.row.status}
          </div>
        } else if (params.row.status == "rejected") {
          return <div style={{ color: 'orange' }} className='text-center p-2'>
            {params.row.status}
          </div>
        } else { return }
      }
